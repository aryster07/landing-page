...
export function DesignerHero() {
    return (
        <section className="min-h-screen flex items-center relative px-6 md:px-20 overflow-hidden">
            {/* Animated Background */}
            <AnimatedBackground mode="designer" />
            ...
            <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pb-20 pt-32">
                <div className="lg:col-span-7 z-10 order-2 lg:order-1">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.95] tracking-tighter mb-8 text-slate-900">
                        <span>
                    ...
                    <p className="reveal-hidden text-lg md:text-xl leading-relaxed max-w-2xl text-slate-600" style={{ transitionDelay: '100ms' }}>
                    ...
                    <div className="reveal-hidden flex flex-wrap gap-4 mt-10" style={{ transitionDelay: '200ms' }}>
                        <a href="#contact" className="px-8 py-3 rounded-full font-bold text-sm tracking-widest uppercase interactive transition-all hover:scale-105 hover:-translate-y-1 bg-slate-900 text-white hover:bg-amber-600">
                            Get in Touch
                        </a>
